  ...
  function (
    ...
    dijitTemplate
      ...
      return declare([_WidgetBase, _TemplatedMixin, Evented], {
          ...
          refresh: function () {
              // all layer info
              this.layers = this.get("map").getLayersVisibleAtScale(); //cc added
              ...
              for (var i = 0; i < loadedLayers.length; i++) {
                  ...
                  if (response) {
                      ...
                      if (layerInfo) {
                          ...
                          var status = this._serviceLayerCheckboxStatus(layer);//cc change
                          ...
                          var localName = layer.id;
                          if (localName === 'Survey and Grid Test') {
                              var here = "";
                          }
          ...
          _toggleLayer: function (layerIndex, subLayerIndex) {
              ...
              if (this.layers && this.layers.length) {
                  ...
                  var layer = layerInfo; //cc changed
                  ...
                  if (featureCollection) {
                      ...
                      if (subLayerIndex !== null) {
                          // Map Service Layer
                          if (layerType === "ArcGISMapServiceLayer" || layerType == undefined) { //cc change
